...
=== TEST 5: discovery_args metadata_match validation
--- config
    location /t {
        content_by_lua_block {
            local schema_def = require("apisix.schema_def")
            ...
            local test_cases = {
                ...
                -- Invalid cases
                {
                    ...
                    upstream = {
                        ...
                        discovery_args = {
                            metadata = {
                                ...
                                env = [true],   -- should be string array
                                count = {},     -- should be array
                    ...
                    expected_error_pattern = "discovery_args.*validation failed.*metadata_match.*validation failed.*wrong type.*expected string"
                },
            }
